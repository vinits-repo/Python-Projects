...
clear = Button(frame, text='clear', height=4, width=4, font=35, command=clear)
clear.grid(row=3, column=4)  # You can adjust the column and columnspan values as needed
